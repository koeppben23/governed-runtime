...
- Apply repository-wide and nested rules cumulatively. A nested rule overrides a
  repository-wide rule only when it explicitly names the rule being replaced and
