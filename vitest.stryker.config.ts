...
export default defineConfig({
  test: {
    ...
    include: [
      ...
      'src/integration/tools-execute-review-standalone.test.ts',
      'src/integration/tools/review-tool/completion.test.ts',
      'src/integration/tools/review-tool/coverage-projection.test.ts',
      'src/integration/tools/review-tool/exact-id-repair.test.ts',
      'src/integration/tools/review-tool/obligation-challenge-binding.test.ts',
      'src/integration/tools/review-tool/obligation-format.test.ts',
      'src/integration/tools/review-tool/review-attempt-lifecycle.test.ts',
      'src/integration/tools/review-tool/structured-evidence-consumption.test.ts',
      'src/integration/tools/review-obligation-classification.test.ts',
      'src/integration/tools/implement-review-unresolved-challenges.test.ts',
      'src/integration/review/observations/observation-binding.test.ts',
      'src/integration/review/observations/pre-bind-findings.test.ts',
      'src/integration/review/observations/observation-replay.test.ts',
