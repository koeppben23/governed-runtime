...
- 18 explicit workflow phases across 3 flows with mandatory evidence gates
...
- Backward transitions on rejection: `changes_requested` returns to authoring phase, `reject` terminates the workflow at `REJECTED`
