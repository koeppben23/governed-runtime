...
| Writer / authority                        | Assurance helpers: [`src/integration/review/obligations/assurance.ts`](../src/integration/review/obligations/assurance.ts). Findings validation: [`src/integration/review/validation/review-validation.ts`](../src/integration/review/validation/review-validation.ts). Review schemas: [`src/state/evidence.ts`](../src/state/evidence.ts). |
