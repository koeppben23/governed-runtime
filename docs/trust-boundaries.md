...
| Writer / authority                        | Assurance helpers: [`src/integration/review/assurance.ts`](../src/integration/review/assurance.ts). Findings validation: [`src/integration/review/review-validation.ts`](../src/integration/review/review-validation.ts). Review schemas: [`src/state/evidence.ts`](../src/state/evidence.ts). |
