...
| Integration Tools             | 19    | `src/integration/tools/index.ts`                    |
| MCP Tools                     | 17    | `src/mcp-server/server.ts`                          |
| Installed Command Definitions | 26    | `src/integration/installed-commands.ts`             |
...
| Mutation Files                | 80    | `stryker.conf.json` `mutate`                        |
