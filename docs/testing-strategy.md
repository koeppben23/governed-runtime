...
The `mutation` job runs StrykerJS mutation testing against 59 security-critical
...
59 files are mutated, covering the fail-closed governance core
...
| **Total**                                                                                                                                                                                                                                                                                                                                            | **59** | uploaded as `reports/mutation/` |
