...
The `mutation` job runs StrykerJS mutation testing against 76 security-critical
files spanning adapters (persistence-lock, host-adapter, persistence),
archive creation,
...
76 files are mutated, covering the fail-closed governance core
(see `stryker.conf.json` for the canonical list):

| Area                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Files  | Representative score            |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------- |
| Adapters (`persistence-lock`, `host-adapter`, `persistence`)                                                                                                                                                                                                                                                                                                                                                                                                                      | 3      | (see latest report)             |
...
| **Total**                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **76** | uploaded as `reports/mutation/` |
