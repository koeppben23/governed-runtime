...
The `mutation` job runs StrykerJS mutation testing against 56 security-critical
...
56 files are mutated, covering the fail-closed governance core
...
| **Total**                                                                                                                                                                                                                                                                                                                                            | **56** | uploaded as `reports/mutation/` |
