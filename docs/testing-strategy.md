...
The `mutation` job runs StrykerJS mutation testing against 72 security-critical
...
plugin-audit, plugin-beforehooks, plugin-afterhooks, plugin-helpers, plugin-audit-lifecycle-reason, review enforcement, review orchestrator,
...
72 files are mutated, covering the fail-closed governance core
...
| Integration (`command-aliases`, `tool-classification`, `discovery-risk-paths`, pre-implementation challenge, architecture submit, `tools/review-validation-mode`, `tools/review-validation`, `tools/review-validation-host-task`, `plugin-audit`, `plugin-beforehooks`, `plugin-afterhooks`, `plugin-helpers`, `plugin-audit-lifecycle-reason`, review enforcement/findings-consistency/orchestrator/detection/output/resolution) | 20     | (see latest report)             |
...
| **Total**                                                                                                                                                                                                                                                                                                                                                                                                                         | **72** | uploaded as `reports/mutation/` |
