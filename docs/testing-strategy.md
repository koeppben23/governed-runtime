...
The `mutation` job runs StrykerJS mutation testing against 60 security-critical
...
60 files are mutated, covering the fail-closed governance core
...
| **Total**                                                                                                                                                                                                                                                                                                                                            | **60** | uploaded as `reports/mutation/` |
