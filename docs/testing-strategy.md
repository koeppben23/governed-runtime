...
The `mutation` job runs StrykerJS mutation testing against 80 security-critical
...
80 files are mutated, covering the fail-closed governance core
(see `stryker.conf.json` for the canonical list):

| Area                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Files  | Representative score            |
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------ | ------------------------------- |
| Adapters (`persistence-lock`, `host-adapter`, `persistence`, `ip-validation`)                                                                                                                                                                                                                                                                                                                                                                                                     | 4      | (see latest report)             |
| Archive (`content-digest`, archive creation, publication, and inventory validation)                                                                                                                                                                                                                                                                                                                                                                                               | 5      | (see latest report)             |
| Audit (`integrity`, `completeness`, `ntp-check`, `types`)                                                                                                                                                                                                                                                                                                                                                                                                                         | 4      | (see latest report)             |
...
| MCP (`execution-limiter`, `session-resolver`, `tool-adapter`)                                                                                                                                                                                                                                                                                                                                                                                                                     | 3      | (see latest report)             |
...
| Integration (`command-aliases`, `tool-classification`, `discovery-risk-paths`, pre-implementation challenge, architecture submit, `tools/review-validation-mode`, `tools/review-validation`, `tools/review-validation-host-task`, `plugin-audit`, `plugin-audit-reconcile`, `plugin-beforehooks`, `plugin-afterhooks`, `plugin-helpers`, `tools/audit-outbox`, `plugin-audit-lifecycle-reason`, review enforcement/findings-consistency/orchestrator/detection/output/resolution) | 22     | (see latest report)             |
...
| Rails (`architecture`, `hydrate`, `review`, `review-url`, `review-decision`, `ticket`)                                                                                                                                                                                                                                                                                                                                                                                            | 6      | (see latest report)             |
| **Total**                                                                                                                                                                                                                                                                                                                                                                                                                                                                         | **80** | uploaded as `reports/mutation/` |
