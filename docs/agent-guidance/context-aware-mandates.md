...
| ------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------- |
| State-machine protocol                | `hydrate`, `ticket`, `plan`, `continue`, `implement`, `validate`, `review`, `architecture`, `review-decision`, `override-approve`, `approve`, `request-changes`, `reject`, `resolve-implementation-challenge`, `reconcile-mutation-episode`, `abort`, `archive`, `finish` | Canonical state transitions and guards in `src/machine/`                  |
