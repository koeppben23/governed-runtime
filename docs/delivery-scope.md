...
| **13 Machine Commands**  | Delivered | hydrate, ticket, plan, continue, implement, resolve-implementation-challenge, review-decision, override-approve, validate, review, architecture, export, abort |
| **7 product aliases**    | Delivered | start, task, approve, request-changes, reject, check, why (+ status read-only)                                                                                 |
