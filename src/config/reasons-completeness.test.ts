...
describe('P10c — reason code split', () => {
  it('all 202 codes from split arrays are registered exactly once (no duplicates)', async () => {
    ...
    expect(allSplitCodes).toHaveLength(202);
    // No duplicates across the 4 arrays
    expect(new Set(allSplitCodes).size).toBe(202);
