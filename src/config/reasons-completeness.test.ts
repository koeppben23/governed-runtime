...
describe('P10c — reason code split', () => {
  it('all 212 codes from split arrays are registered exactly once (no duplicates)', async () => {
    ...
    expect(allSplitCodes).toHaveLength(212);
    // No duplicates across the 4 arrays
    expect(new Set(allSplitCodes).size).toBe(212);
