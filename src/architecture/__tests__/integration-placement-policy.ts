...
export const INTEGRATION_PLACEMENT: readonly IntegrationPlacementEntry[] = [
  ...
  {
    file: 'integration/review/evidence/anchor-contract-lines.ts',
  ...
  {
    file: 'integration/review/evidence/audit-events.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  ...
  {
    file: 'integration/review/prompting/discovery-context-prompt.ts',
    owner: 'review-prompting',
    zone: 'review/prompting',
    targetZone: 'review/prompting',
  },
  ...
  {
    file: 'integration/review/evidence/finding-relation-grammar.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  ...
  {
    file: 'integration/review/prompting/impl-review-prompt.ts',
    owner: 'review-prompting',
    zone: 'review/prompting',
    targetZone: 'review/prompting',
  },
  ...
  {
    file: 'integration/review/prompting/prompt-builders.ts',
    owner: 'review-prompting',
    zone: 'review/prompting',
    targetZone: 'review/prompting',
  },
  {
    file: 'integration/review/prompting/prompt-sections.ts',
    owner: 'review-prompting',
    zone: 'review/prompting',
    targetZone: 'review/prompting',
  },
  ...
  {
    file: 'integration/review/evidence/rejected-digests.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  {
    file: 'integration/review/evidence/report-coherence.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  ...
  {
    file: 'integration/review/evidence/review-provenance.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  ...
  {
    file: 'integration/review/validation/review-validation.ts',
    owner: 'review-validation',
    zone: 'review/validation',
    targetZone: 'review/validation',
  },
  {
    file: 'integration/review/evidence/reviewed-digest.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
  ...
  {
    file: 'integration/review/evidence/reviewer-evidence-recorder.ts',
    owner: 'review-evidence',
    zone: 'review/evidence',
    targetZone: 'review/evidence',
  },
