...
export const INTEGRATION_PLACEMENT: readonly IntegrationPlacementEntry[] = [
  ...
  {
    file: 'integration/review/durable-dispatch.ts',
    owner: 'review',
    zone: 'review',
    targetZone: 'review',
  },
  ...
  {
    file: 'integration/review/native-task-review-bindings.ts',
    owner: 'review',
    zone: 'review',
    targetZone: 'review',
  },
  ...
  {
    file: 'integration/review/review-obligation-classification.ts',
    owner: 'review',
    zone: 'review',
    targetZone: 'review',
  },
