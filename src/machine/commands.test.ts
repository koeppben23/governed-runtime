  ...
  describe("HAPPY", () => {
    ...
    it("wildcard commands allowed in all non-terminal phases", () => {
      const phases: Phase[] = [
        ...
        "ARCHITECTURE", "ARCH_REVIEW", "REVIEW",
      ];
  ...
  describe("BAD", () => {
    it("/ticket blocked outside READY and TICKET", () => {
      const blockedPhases: Phase[] = [
        ...
        "IMPLEMENTATION", "IMPL_REVIEW", "EVIDENCE_REVIEW",
        "COMPLETE", "ARCHITECTURE", "ARCH_REVIEW", "ARCH_COMPLETE",
    ...
    it("/architecture blocked outside READY and ARCHITECTURE", () => {
      const blockedPhases: Phase[] = [
        ...
        "IMPLEMENTATION", "IMPL_REVIEW", "EVIDENCE_REVIEW",
        "COMPLETE", "ARCH_REVIEW", "ARCH_COMPLETE",
        "REVIEW", "REVIEW_COMPLETE",
      ];
      for (const phase of blockedPhases) {
  ...
  describe("CORNER", () => {
    it("all terminal phases block ALL mutating commands", () => {
      ...
      const mutatingCommands: Command[] = [
        Command.HYDRATE, Command.TICKET, Command.PLAN, Command.CONTINUE,
        Command.IMPLEMENT, Command.REVIEW_DECISION, Command.VALIDATE,
        Command.REVIEW, Command.ARCHITECTURE, Command.ABORT,
      ];
