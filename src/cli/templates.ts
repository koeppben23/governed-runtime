...
## Legacy Summary (Deprecated)

The sections below (Developer Mandate, Review Mandate, Output Quality Contract, Risk Tiering, Cross-Cutting Principles) are deprecated. They are retained for backward compatibility only.
