...
4. \`flowguard_architecture({ reviewVerdict: "approve" })\` → ARCH_REVIEW (user gate — the USER approves via /review-decision; this call does NOT approve the ADR)
...
3. After re-reviewing, \`flowguard_architecture({ reviewVerdict: "approve" })\` → ARCH_REVIEW (user gate — the USER decides via /review-decision)
