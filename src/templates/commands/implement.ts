...
4. \`flowguard_implement({ reviewVerdict: "approve" })\` → EVIDENCE_REVIEW (user gate — the USER approves via /review-decision; this call does NOT approve the implementation)
...
4. \`flowguard_implement({ reviewVerdict: "approve" })\` → EVIDENCE_REVIEW (user gate — the USER decides via /review-decision)
